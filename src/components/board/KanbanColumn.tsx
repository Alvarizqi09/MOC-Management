    ...
    >
      <div className="p-4 sm:p-5 pb-2">
        <div className="flex items-center justify-between mb-1.5">
          ...
          <div className="flex h-6 min-w-[24px] items-center justify-center rounded-full bg-slate-100 px-2 text-xs font-medium text-slate-500">
            {tasks.length}
          </div>
        </div>
      ...
      >
        {tasks.length === 0 ? (
          <div className="flex flex-1 items-center justify-center rounded-lg border-2 border-dashed border-slate-100 p-6 text-center mt-3">
      ...
      <div className="p-3 pt-0 mt-auto">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white py-2.5 text-sm font-medium text-slate-600 transition-colors hover:bg-slate-50 hover:text-slate-900"
        >
